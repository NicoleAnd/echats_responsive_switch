...
<script type="text/javascript">
	...
	$.ajax({
		...
		data : {
			"prodId" : window.parent.document.getElementById("custInfo").value, "selectType" : "LOAN_LVL" ,"sortName" : "LOAN_LVL", "paraType" : "A08"
		},
		async : false,
						...
						itemStyle : {
							normal : {
								color : function(params){
									...
									if(params.data > 0 && params.data <= 325200){
										return colorList[0];
									}else if (params.data > 325200 && params.data <= 325700){
										return colorList[1];
									}else if (params.data > 325700 && params.data <= 326200){
										return colorList[2];
									}else if (params.data > 326200 && params.data <= 326700){
										return colorList[3];
									}else if (params.data > 326700 && params.data <= 327200){
										return colorList[4];
									}else if (params.data > 327200 && params.data <= 327700){
										return colorList[5];
									}else if (params.data > 327700 && params.data <= 328200){
										return colorList[6];
									}else if (params.data > 328200 && params.data <= 328700){
										return colorList[7];
									}else {
										return colorList[8];
									}
	...
	function eConsole(param) {
		...
		var url = getCurrentAbsolutePath() + '/design/layout_windows/layoutLoanlvlData.jsp';
		openModel('600px','500px','贷款级别',url);
	}
