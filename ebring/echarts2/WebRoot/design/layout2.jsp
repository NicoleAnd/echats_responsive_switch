...
<body style="padding: 0.5px;">
	<div class="wrap">
		...
		<div id='wrap1' class="containerall">
				...
				<div class="col1">
					<div class="col1row1 cone borderstyle1">
						...
						<div class="bodystyle bone">
							<iframe src="./echartLine/echartAge.jsp" frameborder="0"
				...
				<div class="col2">
					<div class="col2row1 borderstyle1 cfour">
						<div class="titlestyle tfour">
							...
							<!-- <a href="#" class="enlargeicon" title="可放大查看" onclick = "window.parent.showOpen(this,'./echartLine/echartArea.jsp')"></a> -->
						</div>
						<div class="bodystyle bfour">
							<iframe src="./echartLine/echartArea.jsp" frameborder="0"
								width="100%" height="100%" scrolling="no"></iframe>
						</div>
					</div>
					<div class="col2row2">
						<div class="col2row2col1 borderstyle1 cfive">
							<div class="titlestyle tfive">
								<span class="fl">存款级别</span> <a href="#" class="enlargeicon"
									title="可放大查看"
									onclick="window.parent.clicked('人口分布','./echartLine/echartArea.jsp')"></a>
							</div>
						...
						<div class="col2row2col2 borderstyle1 csix">
							<div class="titlestyle tsix">
								<span class="fl">文化程度</span> <a href="#" class="enlargeicon"
									title="可放大查看"
									onclick="window.parent.clicked('人口分布','./echartLine/echartArea.jsp')"></a>
							</div>
				...
				<div class="col3">
					<div class="col3row1 borderstyle1 cseven">
						<div class="titlestyle tseven">
							<span class="fl">贷款级别</span> <a href="#" class="enlargeicon"
								title="可放大查看"
								onclick="window.parent.clicked('人口分布','echart6.jsp')"></a>
						</div>
					...
					<div class="col3row2 borderstyle1 ceeight">
						<div class="titlestyle teeight">
							<span class="fl">月资金流量</span> <a href="#" class="enlargeicon"
								title="可放大查看"
								onclick="window.parent.clicked('人口分布','echart7.jsp')"></a>
						</div>
					...
					<div class="col3row3 borderstyle1 cnine">
						<div class="titlestyle tnine">
							<span class="fl">职业类型</span> <a href="#" class="enlargeicon"
								title="可放大查看"
								onclick="window.parent.clicked('人口分布','echart8.jsp')"></a>
						</div>
			...
			<div class="righthide current"
				style="width: 100%; height: 100%; height: 99%;">
				<div class="col1">
					<div class="col1row1 borderstyle1">
						<div class="titlestyle">
							<span class="fl">人口分布2</span> <a href="#" class="enlargeicon"
								title="可放大查看"
								onclick="window.parent.clicked('人口分布','echart0.jsp')"></a>
						</div>
						<div class="bodystyle">
							<iframe src="./echartLine/echartAge.jsp" frameborder="0"
								width="100%" height="100%" scrolling="no">
					...
					<div class="col1row2 borderstyle1">
						<div class="titlestyle">
							<span class="fl">人口分布</span> <a href="#" class="enlargeicon"
								title="可放大查看"
								onclick="window.parent.clicked('人口分布','echart1.jsp')"></a>
						</div>
						<div class="bodystyle">
							<iframe src="./echartLine/echartAge.jsp" frameborder="0"
								width="100%" height="100%" scrolling="no">
					...
					<div class="col1row3 borderstyle1">
						<div class="titlestyle">
							<span class="fl">人口分布</span> <a href="#" class="enlargeicon"
								title="可放大查看"
								onclick="window.parent.clicked('人口分布','echart2.jsp')"></a>
						</div>
						<div class="bodystyle">
							<iframe src="./echartLine/echartAge.jsp" frameborder="0"
								width="100%" height="100%" scrolling="no">
				...
				<div class="col2">
					<div class="col2row1 borderstyle1">
						<div class="titlestyle">
							<span class="fl">人口分布</span> <a href="#" class="enlargeicon"
								title="可放大查看"
								onclick="window.parent.clicked('人口分布','echart111.jsp')"></a>
						</div>
						<div class="bodystyle">
							<iframe src="./echartLine/echartAge.jsp" frameborder="0"
								width="100%" height="100%" scrolling="no">
					...
					<div class="col2row2">
						<div class="col2row2col1 borderstyle1">
							<div class="titlestyle">
								<span class="fl">人口分布</span> <a href="#" class="enlargeicon"
									title="可放大查看"
									onclick="window.parent.clicked('人口分布','echart4.jsp')"></a>
							</div>
							<div class="bodystyle">
								<iframe src="./echartLine/echartAge.jsp" frameborder="0"
									width="100%" height="100%" scrolling="no">
						...
						<div class="col2row2col2 borderstyle1">
							<div class="titlestyle">
								<span class="fl">人口分布</span> <a href="#" class="enlargeicon"
									title="可放大查看"
									onclick="window.parent.clicked('人口分布','echart5.jsp')"></a>
							</div>
							<div class="bodystyle">
								<iframe src="./echartLine/echartAge.jsp" frameborder="0"
									width="100%" height="100%" scrolling="no">
			...
			<div class="righthide current"
				...
				<div class="col1">
					<div class="col1row1 borderstyle1">
						<div class="titlestyle">
							<span class="fl">人口分布3</span> <a href="#" class="enlargeicon"
								title="可放大查看"
								onclick="window.parent.clicked('人口分布','echart0.jsp')"></a>
						</div>
						<div class="bodystyle"></div>
