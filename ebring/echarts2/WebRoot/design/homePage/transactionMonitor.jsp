...
<body>
   ...
   <div class="wrap">
   		<!-- <div style="background:pink;width:50%;height:50%;">
   			<iframe src="../map/contextmenuMap.jsp"  frameborder="0" width="100%" height="100%" scrolling="no" ></iframe>
   		</div> -->
   		<div class="manageOne borderstyle1">
   			<div class="titlestyle tone">
				<span id="titlesecond" class="fl">交易监控--陕西省</span> 
			...
			<div class="bodystyle bone"><iframe src="../map/contextmenuMap.jsp"  frameborder="0" width="100%" height="100%" scrolling="no" ></iframe></div>
   		</div>
   		<div class="manageTwo borderstyle1">
   			<div class="titlestyle tone">
				<span id="titlesecond" class="fl">交易监控--陕西省-折线图</span> 
				<a href="#"data-method="setTop" class="enlargeicon layui-btn" title="可放大查看"onclick="window.parent.showOpen(this,'./echartLine/echartAge.jsp')"></a>
			</div>
			<div class="bodystyle bone"><iframe src="../echart11.jsp"  frameborder="0" width="100%" height="100%" scrolling="no" ></iframe></div>
   		</div>
   </div>
