...
<body style="padding: 0.5px;">
	<div class="wrap">
		...
		<div class="customerPic">
			<a href="try3-5-1.jsp"><img src="img/return1.png"><span
				class="return">返回</span></a>
		</div>
		<div id='wrap1' class="containerall">
			<div class="righthide current">
					...
					<form role="form">
						<div class="form-group">
							<label for="name">产品列表：</label> <select
								style="color: #000; width: 168px; padding: 1px 3px;"
				...
				<div class="colpicstyle1">
					<div class="pageone borderstyle1">
						<div class="titlestyle pagetitle">
							<span id="titlesecond" class="fl">客户画像</span>
						</div>
						<div class="bodystyle pagebody">
							<iframe id="ifr1" src="./echartLine/echartCustPortrait.jsp" frameborder="0" width="100%"
				...
				<div class="colpicstyle1">
					<div class="pageone borderstyle1">
						<div class="titlestyle pagetitle">
							<span id="titlesecond" class="fl">客户画像数据</span>
						</div>
						<div class="bodystyle pagebody">
							<iframe id="ifr2" src="./echartLine/tableCustData.jsp" frameborder="0" width="100%"
								height="100%" scrolling="no"></iframe>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		function seleT() {
			$("#ifr1").attr("src", "./echartLine/echartCustPortrait.jsp");
			$("#ifr2").attr("src", "./echartLine/tableCustData.jsp");
		}
