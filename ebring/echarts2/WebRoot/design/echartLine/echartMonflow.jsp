...
<script type="text/javascript">
	...
	$.ajax({
		...
		data : {
			"prodId" : window.parent.document.getElementById("custInfo").value, "selectType" : "MON_FLOW" ,"sortName" : "MON_FLOW", "paraType" : "A09"
		},
		async : false,
	...
	function eConsole(param) {
		...
		var url = getCurrentAbsolutePath() + '/design/layout_windows/layoutMonflowData.jsp';
		openModel('600px','500px','月资金流量',url);
	}
