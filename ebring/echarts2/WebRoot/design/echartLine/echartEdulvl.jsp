...
<script type="text/javascript">
	...
	$.ajax({
		...
		data : {
			"prodId" : window.parent.document.getElementById("custInfo").value, "selectType" : "EDU_LVL" ,"sortName" : "EDU_LVL", "paraType" : "A04"
		},
		async : false,
	...
	option = {
		...
		series : [ {
			...
			color:['#FF8247', '#1E90FF', '#68838B','#00F5FF', '#00FF7F', '#7FFF00', '#FFEC8B', '#FFC125',  '#00B2EE', '#9370DB']
		} ]
	};
	...
	function eConsole(param) {
		...
		var url = getCurrentAbsolutePath() + '/design/layout_windows/layoutEdulvlData.jsp';
		openModel('600px','500px','文化程度',url);
	}
