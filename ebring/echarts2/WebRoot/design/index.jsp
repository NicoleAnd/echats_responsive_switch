				...
				<li class="li1">
					...
					<div class="demopage">
                        ...
                        <div id="myscroll">
                            <div id="myscrollbox">
                                <ul>
                                    <li><a href="./layout_tol/layout1.jsp" target="li2_iframe"><div class="scrnav"><div class="nav-icon glyphicon glyphicon-user"></div>客户分布</div></a></li>
                                    <li><a href="./layout_tol/echart1.jsp" target="li2_iframe"><div class="scrnav"><div class="nav-icon glyphicon glyphicon-shopping-cart"></div>舆情走势</div></a></li>
                                    <li><a href="./layout_tol/layout_buy_with.jsp" target="li2_iframe"><div class="scrnav"><div class="nav-icon glyphicon glyphicon-duplicate"></div>产品同购</div></a></li>
                                    <li><a href="./layout_tol/layout3-5-1.jsp" target="li2_iframe"><div class="scrnav"><div class="nav-icon glyphicon glyphicon-duplicate"></div>客户画像</div></a></li>
                    ...
                    <!-- 新增   客户画像 -->
					<!-- <div class="customerPic"><a href="./layout_tol/layout3-5-1.jsp"><img src="img/customer.png">客户画像</a></div> -->
					
				</li>
				<li class="li2">
					<iframe name="li2_iframe" id="li2_iframe" src="./layout_tol/layout1.jsp"  frameborder="0" width="100%" height="100%" scrolling="no" ></iframe>
					<input type="hidden" id="custInfo" value="1">
					<input type="hidden" id="clickNo" value="">
				</li>
			</ul>
		</div>
		<div class="footer">
