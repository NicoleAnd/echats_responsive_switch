   ...
   <div class="wrap">
   		<div class="manageOne borderstyle1">
   			<div class="titlestyle tone">
				<span id="titlesecond" class="fl">舆论关注</span> 
			...
			<div class="bodystyle bone"><iframe src="../echart10.jsp"  frameborder="0" width="100%" height="100%" scrolling="no" ></iframe></div>
   		</div>
   		<div class="manageTwo borderstyle1">
   			<div class="titlestyle tone">
				<span id="titlesecond" class="fl">销量排行</span> 
				<a href="#"data-method="setTop" class="enlargeicon layui-btn" title="可放大查看"onclick="window.parent.showOpen(this,'./echartLine/echartAge.jsp')"></a>
			</div>
			<div class="bodystyle bone"><iframe src="../table3-5-1.jsp"  frameborder="0" width="100%" height="100%" scrolling="no" ></iframe></div>
   		</div>
   </div>
