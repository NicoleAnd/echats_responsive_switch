...
<head>
    ...
    .fanyenav{width: 50px;float: right;height: 25px;bottom: 25px;z-index: 10;line-height: 25px;border: 1px solid #22d66c;box-shadow: 0px 6px 20px #000;border-top-left-radius: 12px;border-bottom-left-radius: 12px;
    	background:#22d66c;}
    .fanyenav span.glyphicon{font-size:16px;line-height: 10px;}
    .fanyelr{float: left;position: absolute;bottom:2px;width: 100px;height: 25px;line-height: 25px;border: 1px solid #22d66c;box-shadow: 0px 6px 20px #000;z-index:20;border-top-left-radius: 12px;border-bottom-left-radius: 12px;
    	background:#22d66c;}
    ...
    .pg_left:hover,.pg_right:hover,.pg_left:focus,.pg_right:focus{diplay:block;width:35px;height:24px;line-height:24px;
    	background: -gradient(linear, 100% 61%, 43% 100%, from(#22d66c), to(#4ad583));
	    background: -o--gradient(linear, 100% 61%, 43% 100%, from(#22d66c), to(#4ad583));
	    background: -ms--gradient(linear, 100% 61%, 43% 100%, from(#22d66c), to(#4ad583));
	    background: -moz-gradient(linear, 100% 61%, 43% 100%, from(#22d66c), to(#4ad583));
	    background: -webkit-gradient(linear, 100% 61%, 43% 100%, from(#22d66c), to(#4ad583));border:1px solid #fff}
    ...
    .stitle{position:absolute;top: 50px;left:43%;width: 200px;height: 40px;text-align: center;line-height: 40px;
	...
	<div class="wrap">
		...
		<div id='wrap1' class="containerall">
			<ul class="containercon">
				...
				<li class="li2">
					<iframe name="li2_iframe" id="li2_iframe" src="layout2.jsp"  frameborder="0" width="100%" height="100%" scrolling="no" ></iframe>
				</li>
			</ul>
		</div>
		<div class="footer">
