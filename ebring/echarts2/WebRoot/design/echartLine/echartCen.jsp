...
<script type="text/javascript">
	...
	$.ajax({
		...
		data : {
			"prodId" : window.parent.document.getElementById("custInfo").value, "selectType" : "CENSUS_REGISTER" ,"sortName" : "CENSUS_REGISTER", "paraType" : "A10"
		},
		async : false,
	...
	option = {
		...
		color:['#00F5FF', '#00FF7F', '#7FFF00', '#FFEC8B', '#FFC125', '#FF8247', '#1E90FF', '#9370DB', '#68838B', '#00B2EE']
	};
	...
	function eConsole(param) {
		...
		var url = getCurrentAbsolutePath() + '/design/layout_windows/layoutCenData.jsp';
		openModel('600px','500px','户籍地分布',url);
	}
