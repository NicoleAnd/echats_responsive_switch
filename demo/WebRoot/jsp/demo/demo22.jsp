...
<style type="text/css">
/* body{background:url('./img/space-2511846.jpg') no-repeat;background-size:cover;} */
.left{height:200px;width:455px;border:1px solid rgba(70,130,180,.6);}      
.center{height:400px;width:450px;border:1px solid #4682b4;}
.right{height:200px;width:455px;border:1px solid rgba(70,130,180,.6);}     
.foot1{height:250px;width:455px;border:1px solid rgba(70,130,180,.6);}     
.foot2{height:250px;width:450px;border:1px solid rgba(70,130,180,.6);}     
.foot3{height:250px;width:455px;border:1px solid rgba(70,130,180,.6);}
