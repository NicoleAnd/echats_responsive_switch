...
<script type="text/javascript">
	...
	$.ajax({
		...
		data : {
			"prodId" : window.parent.document.getElementById("custInfo").value, "selectType" : "OCCU_TYP" ,"sortName" : "OCCU_TYP", "paraType" : "A05"
		},
		async : false,
	...
	option = {
		...
		series : [ {
			...
			color:['#68838B','#00F5FF', '#00FF7F', '#1E90FF', '#00B2EE', '#9370DB', '#7FFF00', '#FFEC8B', '#FFC125', '#FF8247']
		} ]
	};
	...
	function eConsole(param) {
		...
		var url = getCurrentAbsolutePath() + '/design/layout_windows/layoutOccuTypData.jsp';
		openModel('600px','500px','职业类型',url);
	}
