...
<script type="text/javascript">
	...
	$.ajax({
		...
		data : {
			"prodId" : window.parent.document.getElementById("custInfo").value, "selectType" : "DEP_LVL" ,"sortName" : "DEP_LVL", "paraType" : "A07"
		},
		async : false,
	...
	function eConsole(param) {
		...
		var url = getCurrentAbsolutePath() + '/design/layout_windows/layoutDeplvlData.jsp';
		openModel('600px','500px','存款级别',url);
	}
