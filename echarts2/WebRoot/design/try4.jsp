...
<head>
    ...
    .fanyenav{width: 50px;float: right;height: 25px;bottom: 25px;z-index: 10;line-height: 25px;border: 1px solid #FFD301;box-shadow: 0px 6px 20px #000;border-top-left-radius: 12px;border-bottom-left-radius: 12px;
    	background:#FFD301;}
    .fanyenav span.glyphicon{font-size:16px;line-height: 10px;}
    .fanyelr{float: left;position: absolute;bottom:2px;width: 100px;height: 25px;line-height: 25px;border: 1px solid #FFD301;box-shadow: 0px 6px 20px #000;z-index:20;border-top-left-radius: 12px;border-bottom-left-radius: 12px;
    	background:#FFD301;}
	...
	body .layui-layer-shade{opacity: 0.9;}
